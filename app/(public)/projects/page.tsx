...
const formatLocation = (loc: ProjectSummary["location"]) => {
    ...
    const parts = [loc.state || "", loc.country || ""]
        .filter(Boolean)
        .join(", ");
...
function ProjectCard({ project }: { project: ProjectSummary }) {
    ...
    const fundingPercentage =
        project.foundingTarget && project.capitalSought
    ...
    return (
        <article className="group relative flex h-full flex-col overflow-hidden rounded-2xl bg-white shadow-lg transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl">
            ...
            >
                ...
                {project.superBoost && (
                    <span className="absolute right-4 top-4 z-20 rounded-full bg-gradient-to-r from-yellow-400 via-orange-500 to-red-500 px-3 py-1.5 text-xs font-bold uppercase tracking-wide text-white shadow-lg">
                        ⭐ Super Boost
                    </span>
                )}
                {!project.superBoost && project.boost && (
                    <span className="absolute right-4 top-4 z-20 rounded-full bg-gradient-to-r from-purple-600 to-blue-600 px-3 py-1.5 text-xs font-bold uppercase tracking-wide text-white shadow-lg">
                        ⭐ Featured
                    </span>
                )}
                ...
                {project.categories && project.categories.length > 0 && (
                    <div
                        className="absolute left-4 bottom-4 z-20 rounded-full bg-white/90 px-3 py-1.5 text-xs font-bold shadow-lg backdrop-blur-sm"
            ...
            <div className="flex flex-1 flex-col p-5">
                ...
                >
                    <span
                        ...
                        style={{ backgroundColor: stageStyle.border }}
                    />
                    {project.stage}
                </div>
                ...
                <h3 className="mb-2 text-xl font-bold leading-tight text-gray-900">
                    <Link
                        href={detailHref}
                        className="inline-block rounded focus:outline-none focus:ring-2 focus:ring-blue-500/40 transition-colors hover:text-blue-600"
                    >
                        {project.title}
                    </Link>
                </h3>
                    ...
                    <div className="flex items-baseline justify-between">
                        <div>
                            ...
                            <div className="text-2xl font-bold text-gray-900">
                                {currency(project.foundingTarget)}
                            </div>
                        </div>
                        <div className="text-right">
                            ...
                            >
                                {currency(project.capitalSought)}
                            </div>
                        </div>
                    </div>
                ...
                <div className="mt-5 flex gap-2">
                    <Link
                        href={detailHref}
                        className="flex-1 rounded-xl px-5 py-3 text-center text-sm font-bold text-white transition-all duration-300 hover:shadow-lg"
                        style={{
                    ...
                    <Link
                        href={`/projects/${project.hash}#contact`}
                        className="rounded-xl border-2 px-4 py-3 text-sm font-bold transition-all duration-300 hover:bg-blue-50"
                        style={{
                ...
                <div className="mb-3">
                    ...
                    <div className="relative">
                        <select
                            value={countryIso2}
                            onChange={(e) =>
                                onCountryChange(e.target.value.toUpperCase())
                            }
                            ...
                            >
                                ...
                                >
                                    <span
                                        ...
                                        style={{
                                            backgroundColor: stageStyle.border,
                                        }}
                                    />
                                    {stage}
                                </span>
                ...
                <div className="max-h-96 space-y-1 overflow-y-auto">
                    {displayedCategories.map((category) => {
                        ...
                        return (
                            <label
                                key={category}
                                className="flex cursor-pointer items-center gap-2 rounded-lg p-2 text-sm transition hover:bg-gray-50"
                            >
                                <input
                                    type="checkbox"
                                    checked={isSelected}
...
function DiscoverProjectsPageInner() {
    ...
    const [countryIso2, setCountryIso2] = useState(
        (searchParams?.get("iso2") || "").toUpperCase().slice(0, 2),
    );
                ...
                <div className="relative mx-auto max-w-7xl px-6">
                    <div className="mb-8">
                        ...
                        <p className="text-lg text-gray-600">
                            Browse {pagination.total} innovative startups
                            seeking funding
                        </p>
                    </div>
                    ...
                    <div className="flex flex-wrap items-center gap-3">
                        ...
                        {selectedCategories.size > 3 && (
                            <span className="rounded-full bg-gray-100 px-3 py-1.5 text-sm font-medium text-gray-600">
                                +{selectedCategories.size - 3} more
                            </span>
                        )}
                    </div>
                </div>
