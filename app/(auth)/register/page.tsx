...
function RegisterPageInner() {
    ...
    useEffect(() => {
        ...
        if (t === "investor" || t === "founder") {
            setRole(t as "founder" | "investor");
        }
    }, [qs]);
                    ...
                    <div className="mt-8 grid gap-4">
                        <div className="flex items-start gap-4 rounded-2xl bg-white p-5 shadow-lg ring-1 ring-blue-100">
                            ...
                            <div>
                                ...
                                <div className="mt-1 text-sm text-gray-600">
                                    Display your pitch, funding stage, and raise
                                    details in a structured investor-friendly
                                    format
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start gap-4 rounded-2xl bg-white p-5 shadow-lg ring-1 ring-blue-100">
                            ...
                            <div>
                                ...
                                <div className="mt-1 text-sm text-gray-600">
                                    Qualified investors can reach out directly.
                                    You decide who to engage with
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start gap-4 rounded-2xl bg-white p-5 shadow-lg ring-1 ring-blue-100">
                            ...
                            <div>
                                ...
                                <div className="mt-1 text-sm text-gray-600">
                                    High-traction projects get featured placement
                                    and newsletter spotlights
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        >
                            ...
                            <div className="relative">
                                ...
                                <p className="mt-2 text-blue-100">
                                    Join the directory and connect{" "}
                                    {role === "founder"
                                        ? "with investors"
                                        : "with founders"}
                                </p>
                            ...
                            <div>
                                ...
                                <div className="mt-3">
                                    ...
                                    <p className="mt-2 text-xs text-gray-500">
                                        Use at least 8 characters. Longer &amp;
                                        mixed = stronger.
                                    </p>
                                </div>
                            </div>
